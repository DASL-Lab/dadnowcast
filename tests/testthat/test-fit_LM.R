test_that("fit simple model works", {
  ...
  expect_equal(test_mod[[2]][[1]], 1)
  expect_equal(test_mod[[2]][[2]], 1.5)
  expect_equal(test_mod[[2]][[3]], 2)
})
...
test_that("fitting simple model with multiple explanatory variables works", {
  ...
  expect_equal(test_mod[[2]][[1]], 0.9950741, tolerance = 0.001)
  expect_equal(test_mod[[2]][[2]], 1.3653039, tolerance = 0.001)
  expect_equal(test_mod[[2]][[3]], 1.7355338, tolerance = 0.001)
})